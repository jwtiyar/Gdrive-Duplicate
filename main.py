...
def main():
    ...
    print("  Open your browser and navigate to: http://0.0.0.0:8000")
    print("  Or use your Tailscale IP to access from other devices")
    print("=" * 70 + "\n")
    
    # We pass the application instance directly to avoid string import issues in PyInstaller
    uvicorn.run(main_app.app, host="0.0.0.0", port=8000, log_level="info")
